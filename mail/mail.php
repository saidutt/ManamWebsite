...
if(isset($_POST['email'])) {
  ...
  $transport = Swift_SmtpTransport::newInstance('smtp.gmail.com', 587, 'tls')
	  ->setUsername('happycodelabs@gmail.com')
	  ->setPassword('HAPPY@3cl')
	  ;
	...
	$message = Swift_Message::newInstance('A message from Manam Contact Form')
	  ->setFrom(array($_POST['email'] => $_POST['name']))
	  ->setTo(array('themanamapp@gmail.com' => 'Manam App'))->setBody($messageText);
//                           ^                    ^
